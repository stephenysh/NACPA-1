...
from examples.gray_oracle_mydata import MyDataset
...
def closure():
    ...
    global final_ssim, final_ssim_max, sigma, test_img_root, final_ssim_max_record
...
output_dir = 'results/rcan_gray_sigma20/'
