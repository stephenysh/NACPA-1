...
if __name__ == '__main__':
    ...
    # data_set12 = glob.glob(os.path.join("../test_sets/kodim", "*.png"))
    data_set12 = glob.glob(os.path.join("../test_sets/Urban100", "*.png"))
    # data_set12 = glob.glob(os.path.join("../test_sets/CBSD68", "*.jpg"))
    # data_set12 = glob.glob(os.path.join("../test_sets/MANGA109", "*.png"))
    # data_set12 = glob.glob(os.path.join("../test_sets/McMaster", "*.tif"))
    ...
    data_set12_recovery = glob.glob(os.path.join("/tmp/pycharm_project_790/1/nac_offline_results/memnet_urban100_10_rgb_no_augs", "*.png"))
    # data_set12_recovery = glob.glob(os.path.join("../test_output/memnet_mcmaster_10_rgb_no_augs", "*.tif"))
    ...
    for i in range(len(data_set12)):
        ...
        img_set12 = cv2.imread(str(data_set12[i]))
        ...
        ssim_deblocking = compare_ssim(img_set12/255., img_set12_recovery/255.,data_range=1, multichannel=True)
